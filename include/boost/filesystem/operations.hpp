 ...
 * [`stat()`](https://pubs.opengroup.org/onlinepubs/000095399/functions/stat.html).
 *
 ...
 * \effects
 * Determines the attributes and access permissions of the file `p` resolves to, as if by ISO/IEC 9945
 * [`lstat()`](https://pubs.opengroup.org/onlinepubs/000095399/functions/lstat.html). If determining succeeded:
 *
